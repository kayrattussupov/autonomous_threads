...
Указывай только реальные нарушения, не больше 3 самых важных, каждое — одним
коротким предложением (до 150 символов) с конкретной правкой. Не цитируй пост
целиком и не пересказывай геном.
